...
б. Было бы эффективнее упразднить таблицу employees.title перенеся поле должности сотрудника и дату его окончания работы на ней в справочник сотрудников employee, поскольку при добавлении сотрудника всегда ему присваивается должность. В такой модели следует создать отдельный справочник должностей, что займет меньше места на диске нежели текущая структура и будет более приемлемо с точки зрения нормальзации структуры данных.
