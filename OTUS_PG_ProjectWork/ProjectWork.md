...
employees=#
```
## Приведение структуры данных в нормализованный вид.
6) Избавляемся от таблицы справочника руководителей подразделений employees.department_manager (см. выше - нормализация).
